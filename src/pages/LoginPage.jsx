    ...
    return(
        <div className="vh-100 d-flex justify-content-center align-items-center">
            <div style={{minWidth: 700}}>
                ...
                <TextBox title={"E-mail vagy felhasználónév"} type={"text"} placeholder={"Add meg az email cimed te cigány vagy a felhasználóneved csóró"} value={usernameOrEmail} setValue={setUsernameOrEmail}/>
